...
const TabNavigator = () => {
  return (
    <TabBarNavigator.Navigator tabBar={(props) => <TabBar {...props} />}>
      <TabBarNavigator.Screen name='Assets' component={HomeNavigator} />
      <TabBarNavigator.Screen name='Trade' component={PortfolioScreen} />
      <TabBarNavigator.Screen name='Actions' component={ActionsScreen} />
      <TabBarNavigator.Screen name='Pay' component={PricesScreen} />
